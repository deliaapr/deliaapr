                                ...
                                <div class="card shadow-lg border-0 rounded-lg mt-5">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="form-floating mb-3">
                                            ...
                                            <div class="form-floating mb-3">
                                                <input class="form-control" id="inputEmail" type="text" placeholder="Masukkan Alamat" name="alamat" />
                                                <label>Alamat</label>
                                            </div>
                                            <div class="form-floating mb-3">
                                                <input class="form-control" id="inputEmail" type="text" placeholder="Masukkan Username" name="username" />
                                                <label for="inputEmailAdress">Username</label>
                                            </div>
                                            <div class="form-floating mb-3">
